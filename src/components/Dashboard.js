...
const Dashboard = (props) => {
  ...
  function handleClicksub() {
    ...
    var count_phone_detect = sessionStorage.getItem("count_phonedetect")
    var count_persondetect = sessionStorage.getItem("count_persondetect")
    ...
    con_db.on('value', (snapshot) => {
      ...
      con_db.child(codeexam).child(PIDs).set({
        ...
        phone: count_phone_detect,
        no_person: count_persondetect,
